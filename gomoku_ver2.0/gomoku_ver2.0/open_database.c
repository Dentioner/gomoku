...
void open_base()
{
	int vector, select_a_empty_point;
	...
	{
		select_a_empty_point = rand() % 8;
		coordinate[0] = empty_point[select_a_empty_point][0];
		coordinate[1] = empty_point[select_a_empty_point][1];
	}
}